...
$APPLICATION->SetPageProperty("tags", "Оформить заказ, Помощь, Ответы на вопросы");
$APPLICATION->SetPageProperty("description", "Бесплатно подберем характеристики бетона исходя из ваших условий строительства и рассчитаем объем. Правильно определим марку бетона, подвижность, водонепроницаемость, морозостойкость. Характеристик бетона много - тут главное не ошибиться!");
//$APPLICATION->SetPageProperty("title", "Помощь в подборе характеристик товарного бетона и расчете объема|«#SELECT_3#»");
$APPLICATION->SetTitle("Помощь в подборе марки бетона и расчёте объема раствора");
?>
<?
if($regionDescriptionTop = show_region_descripotion()){
    echo $regionDescriptionTop;
}else{?>
    <h2 class="no-top-space">Помощь в выборе характеристик бетона</h2>
<h3>Подскажем марку бетона</h3>
<p>
	Нередко строители сталкиваются с проблемой правильного подбора марки прочности бетонного раствора. Разные марки подходят для различного типа монолитного строительства. Опытные проектировщики указывают марку на стадии составления проекта, но даже они могут ошибиться с классом бетонной смеси, из-за нюансов производства. Ошибка может стоить очень дорого и сказаться на прочности монолитной конструкции или на цене сооружения. Так что делать тем, кто не в курсе какую марку бетона нужно купить? На этот вопрос вам ответят специалисты бетонного завода «#SELECT_3#». Позвоните нам по телефону: #TEL#, мы не только подберем правильную марку бетона, но и подскажем другие характеристики бетона исходя из ваших условий строительства.
</p>
<h3>Подберем коэффициент подвижности смеси</h3>
<p>
	Коэффициент подвижности или как его еще называют текучести бетона, имеет очень важное значение при подаче раствора бетононасосом. В свою очередь подвижность смеси рассчитывается исходя из мощности АБН, длинны трассы и высоты подъема, например на этаж. Это очень важная характеристика, указывающая на способность насоса прокачать жидкий бетон в заданных условиях. Чтобы не ошибиться - обращайтесь к нашим специалистам за помощью в расчете подвижности бетона.
</p>
<h3>Рассчитаем коэффициент водонепроницаемости</h3>
<p>
	Вы не знаете какая водонепроницаемость бетона должна быть для заливки вашего объекта? Мы бесплатно рассчитаем коэффициент водонепроницаемости в зависимости от ваших условий эксплуатации, наличия прямого контакта с водой, чтобы бетон не покрывался плесенью и грибком. Звонит! Наши консультации бесплатные!
</p>
<h3>Вычислим коэффициент морозостойкости</h3>
<p>
	Еще одной немаловажной характеристикой монолита является его морозостойкость. Эта величина рассчитывается исходя из климатических условий. Есть руководящие документы указывающие на требуемую величину морозостойкости. И если вы не хотите терять время на определение этой величины, то лучше обратиться к профильным специалистам.
</p>
    <h2 class="no-top-space">Правильно рассчитаем объем бетона для заливки</h2>
<h3>Расчёт объема с учетом коэффициента усадки</h3>
<p>
	При расчете объема бетона для заказа на производстве, мало кто вспоминает о том, что раствор бетона дает усадку. Раствор растекается и впитывается в почву, из-за чего происходят естественные потери. Все это необходимо учитывать при расчете объема бетона. Наш инженер бесплатно произведет замеры и правильно рассчитает кубатуру смеси, чтобы не пришлось в случае нехватки дозаказывать строительный материал в срочном порядке. А время играет ключевую роль при монолитном строительстве - нельзя допустить образование холодного шва.
</p>
<blockquote>
Холодный шов в монолитном строительстве - это разрыв в бетонной конструкции, который происходит из-за перерыва в работе или из-за того, что два участка бетонирования соседних секций бетонируются независимо друг от друга. Холодные швы могут влиять на прочность и надежность конструкции, поэтому важно не допускать их появление.
</blockquote>
<p>
<b>Наши специалисты, под ответственность бетонного завода «#SELECT_3#», произведут расчёт объема с учетом всех особенностей условий строительства. В случае нехватки раствора, завод доставит недостающий объем в течение 40 минут.</b>
</p>
