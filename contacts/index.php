...
$APPLICATION->SetPageProperty("tags", "Контакты, #ZAVOD_NAME#, Строительство, Ответы на вопросы, Телефон, Почта, Адрес");
$APPLICATION->SetPageProperty("description", "Контакты бетонного завода «#SELECT_3#» в #REGION_NAME_DECLINE_PP#. Телефон #TEL_PHONE#, почта [#MAIL#], адрес #SELECT_7#, работаем 24/7.");
//$APPLICATION->SetPageProperty("keywords_inner", "купить бетон, заказать бетон, контакты, сколько бетона, цена с доставкой");
$APPLICATION->SetPageProperty("title", "Контакты: адрес, номер телефона, почта бетонного завода «#SELECT_3#» в #REGION_NAME_DECLINE_PP#");
$APPLICATION->SetTitle("Контакты бетонного завода «#SELECT_3#» в #REGION_NAME_DECLINE_PP#");?>
