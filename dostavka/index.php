...
$APPLICATION->SetPageProperty("description", "Расчет стоимости доставки товарного бетона по #SELECT_8# от бетонного завода «#SELECT_3#». Построение маршрута следования миксера от РБУ до строительной площадки.");
$APPLICATION->SetPageProperty("title", "Калькулятор доставки товарного бетона по #REGION_NAME_DECLINE_TP# и #SELECT_8#|«#SELECT_3#»");
$APPLICATION->SetPageProperty("viewed_show", "N");
$APPLICATION->SetTitle("Калькулятор доставки бетона по #REGION_NAME_DECLINE_TP# и Московской области");
?><?
...
<?}?>
            ...
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "H1" => "Калькулятор доставки бетона по #REGION_NAME_DECLINE_TP# и области",
                    "PATH_DESCRIPTION_AREA" => "include/mainpage/inc_files/fastorderDostavka.php"
                ),
                $component
            );
            ?>
...
<?
if($regionDescriptionTop = show_region_descripotion(true)){
    echo $regionDescriptionTop;
}else{?>
<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
        "AREA_FILE_SHOW" => "sect",
...
<div class="container">
<div class="maxwidth-theme"><?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>