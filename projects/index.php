...
$APPLICATION->SetPageProperty("description", "Мы успешно выполнили более 140 строительных проектов в #SELECT_8#. Наши работы успешно прошли проверку экспертами ростехнадзора.");
$APPLICATION->SetPageProperty("title", "ПОРТФОЛИО – Свыше 140 проектов бетонного завода «#SELECT_3#»");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FORM_ID" => "",
		"GALLERY_TYPE" => "big",
		"T_GOODS" => "В проекте использовалось",
		"T_SERVICES" => "",
		...
		"BLOCK_STAFF_NAME" => "Сотрудник ответственный за проект",
		"BLOCK_VACANCY_NAME" => "Вакансии",
		"BLOCK_PROJECTS_NAME" => "Проекты",
		"BLOCK_BRANDS_NAME" => "Производим марки бетона на заводе «АРИС»",
		"BLOCK_BLOG_NAME" => "Статьи",
		"BLOCK_LANDINGS_NAME" => "Коллекции",
		"STAFF_TYPE_DETAIL" => "list",
		"DETAIL_BLOCKS_ALL_ORDER" => "tizers,desc,map,staff,char,docs,goods,reviews,services,partners,news,vacancy,blog,gallery,form_order,projects,brands,landings,comments,video",
