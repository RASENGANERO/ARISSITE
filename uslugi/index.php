...
$APPLICATION->SetPageProperty("tags", "Бесплатные услуги, Помощь и консультация, Выезд на объект");
$APPLICATION->SetPageProperty("description", "Бетонный завод «#SELECT_3#» оказывает бесплатные комплексные услуги по сопровождению бетона: от помощи в выборе марки раствора до проведения лабораторных испытаний.");
$APPLICATION->SetPageProperty("title", "Бесплатные услуги бетонного завода «#SELECT_3#»-Полное сопровождение под ключ");
$APPLICATION->SetPageProperty("viewed_show", "Y");
$APPLICATION->SetTitle("Бесплатные услуги бетонного завода «#SELECT_3#»");
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_BLOCKS_ALL_ORDER" => "tizers,form_order,desc,char,gallery,docs,services,news,vacancy,blog,goods,projects,reviews,partners,staff,brands,landings,comments",
