...
$APPLICATION->SetPageProperty("tags", "О компании, Производство, Бетонный завод, Готовый бетон");
$APPLICATION->SetPageProperty("description", "#ZAVOD_NAME# – масштабное производство товарного бетона и строительных цементных растворов с доставкой собственными миксерами по #REGION_NAME_DECLINE_TP# и области.");
//$APPLICATION->SetPageProperty("keywords", "о бетонном производстве в #REGION_NAME_DECLINE_PP#");
$APPLICATION->SetPageProperty("title", "О #ZAVOD_NAME_PP# – производитель бетона в #REGION_NAME_DECLINE_PP#");
...
<h2>Общество с ограниченной ответственностью «АРИС»</h2>
<p>
ОГРН: 1247700182465<br>
ИНН: 9731131044<br>
КПП: 773101001<br>
121609, Россия, г.Москва, ул.Осенняя, д.23, пом. 59/1/1.<br>
Расч. счет: 40702810810001569493<br>
АО «ТИНЬКОФФ БАНК»<br>
БИК: 044525974 Корр. счет: 30101810145250000974<br>
</p>
<p>
<b>Проверить наши сертификаты и декларации на сайте федеральной службы по аккредитации: <a title="Декларация на бетон ООО «АРИС»" href="https://pub.fsa.gov.ru/rds/declaration/view/18813891/common" rel="nofollow" target="_blank" >Ссылка на декларацию</a></b>
</p>
<?}
?>
