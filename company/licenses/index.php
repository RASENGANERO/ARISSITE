...
$APPLICATION->SetPageProperty("title", "Декларации и сертификаты ГОСТ на бетонные смеси и растворы строительные|«#SELECT_3#»");
$APPLICATION->SetTitle("Декларации ГОСТ");
?>
<?
