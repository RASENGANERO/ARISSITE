...
$APPLICATION->SetPageProperty("description", "Наши клиенты и надежные партнеры при строительстве монолитных зданий и сооружений в #SELECT_8#. Строительные компании, управляющие компании, частные застройщики.");
$APPLICATION->SetPageProperty("title", "Клиенты бетонного завода «#SELECT_3#»");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"BLOCK_STAFF_NAME" => "Персональный менеджер",
		...
		"DETAIL_BLOCKS_ALL_ORDER" => "tizers,goods,desc,char,docs,services,news,vacancy,blog,reviews,projects,staff,comments,brands,gallery,video,landings,form_order,partners,sale",
		...
		<div class="container">
			<div class="maxwidth-theme">
				<div class="ordered-block partners with-title">
					<div class="ordered-block__title option-font-bold font_lg ">Наши клиенты</div>
