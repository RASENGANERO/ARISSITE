...
$APPLICATION->SetPageProperty("description", "Оформление покупки у производителя — собственные бетонные заводы и спецтехника в Москве и Московской области.");
$APPLICATION->SetPageProperty("keywords", "Покупка, аренда, бетон, цементная смесь, ЦПС, цементный раствор");
$APPLICATION->SetPageProperty("title", "Оформление заказа — «Московский бетон»");
...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"MESS_COUPON" => "Купон",
		"MESS_DELIVERY_BLOCK_NAME" => "Расчёт стоимости доставки",
