...
$APPLICATION->SetPageProperty("title", "Справочная информация — #ZAVOD_NAME#");
$APPLICATION->SetPageProperty("description", "Как выбрать, купить, оплатить и доставить бетон, арендовать АБС и АБН в #REGION_NAME_DECLINE_PP#.");
//$APPLICATION->SetPageProperty("keywords", "помощь, справка, доставка, бетон, цементный раствор, выбор");
