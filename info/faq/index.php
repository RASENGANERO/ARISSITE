...
$APPLICATION->SetPageProperty("title", "Часто задаваемые вопросы - бетонный завод «#SELECT_3#»");
$APPLICATION->SetPageProperty("description", "Отвечаем на популярные вопросы клиентов бетонного завода «#SELECT_3#». Краткие ответы на частые вопросы о бетоне, его производстве и доставке.");
...
<?
    global $faqFilter;
    $faqFilter = ['!PROPERTY_FOR_CATALOG_VALUE' => 'Y'];
?>
