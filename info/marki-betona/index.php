...
$APPLICATION->SetPageProperty("description", "Все марки бетона в одном месте. Характеристики, прочность, состав.");
$APPLICATION->SetPageProperty("title", "Марки бетона-Характеристики М50-М1000|«#SELECT_3#»");
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"BLOCK_BRANDS_NAME" => "Ближайшие по прочности марки бетона",
		"BLOCK_LANDINGS_NAME" => "",
		"BLOCK_NEWS_NAME" => "Новости",
		"BLOCK_PARTNERS_NAME" => "Клиенты",
		"BLOCK_PROJECTS_NAME" => "Бетон этой марки использовался в проектах",
		...
		"DETAIL_BLOCKS_ALL_ORDER" => "desc,tizers,goods,char,docs,services,news,vacancy,blog,projects,brands,partners,reviews,staff,gallery,landings,goods_sections,goods_catalog,comments,form_order",
