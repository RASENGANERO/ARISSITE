...
$APPLICATION->SetTitle("Бетон цена за 1 м3 с доставкой в прайсе бетонного завода «#SELECT_3#»");
$APPLICATION->SetPageProperty("description", "Актуальные цены на бетон за 1 м3 с доставкой по #SELECT_8# на #SELECT_2# год. Цена бетона указана с НДС. Скачать прайс на товарный бетон завода «#SELECT_3#».");
$APPLICATION->SetPageProperty("title", "Бетон цена за 1 м3 с доставкой в прайсе бетонного завода «#SELECT_3#»");
?>
...
<?$APPLICATION->IncludeComponent("bitrix:news", "catalog_price", Array(
	...
	"SEF_FOLDER" => "/price/",	// Каталог ЧПУ (относительно корня сайта)
        ...
        <div class="content_wrapper_block">
            <div class="maxwidth-theme fast-order-box">
                <?php $APPLICATION->IncludeFile("/include/about-factory.php", [
                    'itemId' => !empty($arFields["PROPERTY_ABOUT_FACTORY_ITEM_ID_VALUE"]) ? $arFields["PROPERTY_ABOUT_FACTORY_ITEM_ID_VALUE"] : null
                ]);?>
            </div>
        </div>
    <?php endif?>
...
<?php if ($arFields["PROPERTY_CONCRETE_GRADES_CHECK_VALUE"] == "Y"):?>
        ...
        <?=CMax::ShowPageType('mainpage', 'catalog_sections', 'front_sections_only');?></div>
	<?php endif?>
