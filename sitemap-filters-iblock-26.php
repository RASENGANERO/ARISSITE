...
$sitemapHost = dirname(__FILE__) . "/aspro_regions/sitemap/sitemap-filters-iblock-26_{$hostname}.xml";
$sitemapDefault = dirname(__FILE__) . "/sitemap-filters-iblock-26.xml";
