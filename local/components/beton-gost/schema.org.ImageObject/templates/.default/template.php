...
<div itemscope itemtype="http://schema.org/ImageObject" <?if(!empty($arParams['ITEMPROP'])):?>itemprop="<?=$arParams['ITEMPROP']?>" <?endif?><?if($arParams['SHOW'] == "Y"):?>style="display: none;" <?endif?>>
	...
	<?if(!empty($arParams['CONTENTURL'])):?>
		<img data-replace="<?=$arParams['CONTENTURL']?>" src="<?=$arParams['CONTENTURL']?>" itemprop="contentUrl" alt="<?if(!empty($arParams['NAME'])):?><?=$arParams['NAME']?><?endif?>" />
	<?endif?>

	<div <?if($arParams['SHOW'] == 'IMG'):?> style="display: none;"<?endif?>>

        <?if(!empty($arParams['URL'])):?>
            <meta itemprop="url" href="<?=$arParams['URL']?>">
        <?endif?>
		...
		<?if(!empty($arParams['TRUMBNAIL_CONTENTURL'])):?>
			<div itemscope itemtype="http://schema.org/ImageObject" itemprop="thumbnail">
				<img data-replace="<?=$arParams['TRUMBNAIL_CONTENTURL']?>" src="<?=$arParams['TRUMBNAIL_CONTENTURL']?>" itemprop="contentUrl" alt="<?if(!empty($arParams['NAME'])):?><?=$arParams['NAME']?><?endif?>" />
			</div>
		<?endif?>
