$(document).ready(function(){
	...
	function setActiveLink() {
		$('.landings-list__info .landings-list__info-wrapper .landings-list__item').removeClass('active-link');
		$('.landings-list__info .landings-list__info-wrapper .landings-list__item').each(function(i, e){
			if ($(e).find('a').first().attr('href') == location.pathname) {
				$(e).addClass('active-link');
			}
		})

		/*$('.landings-list__info').each(function(index, el){
			$(el).find('.landings-list__item').each(function(i, e){
