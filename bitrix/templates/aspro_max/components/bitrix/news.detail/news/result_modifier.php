...
$arResult['FIELDS']['DETAIL_TEXT'] = str_replace(array("#NAME#", "#SNAME#", "#PRICE#"), array($arResult["NAME"], mb_strtolower($arResult["NAME"]), $arResult['PROPERTIES']['PRICE']['VALUE']), $arResult['FIELDS']['DETAIL_TEXT']);


$arResult["NOINDEX"] = !empty($arResult["PROPERTIES"]["NOINDEX"]["VALUE"]) ? $arResult["PROPERTIES"]["NOINDEX"]["VALUE"] : 'N';

$this->__component->SetResultCacheKeys(["NOINDEX"]);