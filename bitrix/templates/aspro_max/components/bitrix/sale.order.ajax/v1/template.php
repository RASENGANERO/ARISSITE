			...
			<div class="col-sm-9 bx-soa">
				...
				<div class="pandd">
					<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
						...
						<!--	DELIVERY BLOCK	-->
						<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : 'style="width:100%;"')?>>
							<div class="bx-soa-section-title-container">
								<h2 class="bx-soa-section-title col-sm-9">
		...
		if ($arParams['PICKUP_MAP_TYPE'] === 'yandex')
		{
			...
			<script>
				(function bx_ymaps_waiter(){
					...
					{
						ymaps.ready(BX.proxy(BX.Sale.OrderAjaxComponent.initMaps, BX.Sale.OrderAjaxComponent)).then(function(){
								console.log('Y.Map Loading show prealoder here...');
