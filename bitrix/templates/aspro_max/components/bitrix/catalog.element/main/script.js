  ...
  window.JCCatalogElement.prototype.SetSliderPict = function (obj, slider, config) {
    ...
    if (slider.length) {
      for (var i in slider) {
        if (typeof slider[i] == "object") {
          slideHtml +=
            ...
            slider[i].BIG.src +
            '" data-fancybox="gallery" class="product-detail-gallery__link fancy"><img class="12 product-detail-gallery__picture" border="0" src="' +
            /*slider[i].SMALL.src +*/
            '" ' + slider[i].SRCSET +
            '" alt="' +
            slider[i].ALT +
      ...
      slideHtml +=
        ...
        '<span class="product-detail-gallery__link"><img class="23 product-detail-gallery__picture" border="0" src="' +
        obj.NO_PHOTO.SRC +
        '" alt="' +
        obj.NAME +
        '" title="' +
    ...
    if (config.mainPictureMode == "MAGNIFIER") {
      ...
      if (slider && slider[0]) {
        pict =
          '<img class="34 product-detail-gallery__picture zoom_picture" border="0" src="' +
          slider[0].SMALL.src +
          '" alt="' +
          slider[0].ALT +
          '" title="' +
        ...
        pict =
          '<img class="35 product-detail-gallery__picture one" border="0" src="' +
          obj.NO_PHOTO.SRC +
          '" alt="' +
          obj.NAME +
          '" title="' +
