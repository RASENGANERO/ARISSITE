...
$MESS['BACK_LINK'] = 'Список марок бетона';

$MESS['T_REVIEWS'] = 'Отзывы';
$MESS['T_DOCS'] = 'Рекомендательные письма';
$MESS['T_PROJECTS'] = 'Проекты';
$MESS['T_GOODS'] = 'Производство растворов марки #BRAND_NAME# на бетонном заводе «#SELECT_3#»';
$MESS['T_GOODS_SECTION'] = 'Разделы с бетоном марки #BRAND_NAME# производства собственного бетонного завода';
