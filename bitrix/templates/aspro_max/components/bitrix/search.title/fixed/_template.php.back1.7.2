		...
		<div class="maxwidth-theme">
			<div class="col-md-12">
				<div class="search-wrapper">
					<div itemscope itemtype="https://schema.org/WebSite" id="<?=$CONTAINER_ID?>">
						<form itemprop="potentialAction" itemscope itemtype="https://schema.org/SearchAction" action="<?=$arResult["FORM_ACTION"]?>" class="search">
							<div class="search-input-div">
								<meta itemprop="target" content="<?echo $arResult["FORM_ACTION"]?>?q={query}"/>
