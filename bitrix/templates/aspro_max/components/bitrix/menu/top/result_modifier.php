...
if($arResult){
	...
	$bRightSide = isset($arTheme['SHOW_RIGHT_SIDE']['VALUE']) ? ($arTheme['SHOW_RIGHT_SIDE']['VALUE'] == 'Y') : ($arTheme['SHOW_RIGHT_SIDE'] == 'Y');
	$bManyItemsMenu = ($MENU_TYPE == '4');
	
	$bRightBanner = $bRightSide && isset($arTheme['SHOW_RIGHT_SIDE']['DEPENDENT_PARAMS']['RIGHT_CONTENT']['VALUE']) && $arTheme['SHOW_RIGHT_SIDE']['DEPENDENT_PARAMS']['RIGHT_CONTENT']['VALUE'] == 'BANNER';
	$bRightBrand = $bRightSide && isset($arTheme['SHOW_RIGHT_SIDE']['DEPENDENT_PARAMS']['RIGHT_CONTENT']['VALUE']) && $arTheme['SHOW_RIGHT_SIDE']['DEPENDENT_PARAMS']['RIGHT_CONTENT']['VALUE'] == 'BRANDS';
