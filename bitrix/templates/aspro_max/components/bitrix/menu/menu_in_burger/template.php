...
<?
global $arTheme;
$iVisibleItemsMenu = (isset($arTheme['MAX_VISIBLE_ITEMS_MENU']['VALUE']) && $arTheme['MAX_VISIBLE_ITEMS_MENU']['VALUE'] ? $arTheme['MAX_VISIBLE_ITEMS_MENU']['VALUE'] : 10);
?>
<?if($arResult):?>
							...
							<div class="burger-dropdown-menu row">
								...
								<div class="menu-wrapper" >
									...
									<?foreach($arResult['EXPANDED']["CHILD"] as $arSubItem):?>
										...
										<?$bHasPicture = (isset($arSubItem['PARAMS']['PICTURE']) && $arSubItem['PARAMS']['PICTURE'] && (isset($arTheme['SHOW_CATALOG_SECTIONS_ICONS']['VALUE']) ? $arTheme['SHOW_CATALOG_SECTIONS_ICONS']['VALUE'] : $arTheme['SHOW_CATALOG_SECTIONS_ICONS']) == 'Y');?>
							...
							<div class="burger-dropdown-menu">
								...
								<div class="menu-wrapper" >
									...
									<?foreach($arItem["CHILD"] as $arSubItem):?>
										...
										<?$bShowChilds = $arParams["MAX_LEVEL"] > 2;?>
										<?$bHasPicture = (isset($arSubItem['PARAMS']['PICTURE']) && $arSubItem['PARAMS']['PICTURE'] && isset($arTheme['SHOW_CATALOG_SECTIONS_ICONS']['VALUE']) && $arTheme['SHOW_CATALOG_SECTIONS_ICONS']['VALUE'] == 'Y');?>
