									...
									<div class="offer_buy_block">
										...
										<div class="counter_wrapp ce_cmp_visible">
											<div id="<?=$arItemIDs["ALL_ITEM_IDS"]['BASKET_ACTIONS']; ?>" class="button_block wide">
												<a class="btn btn-default basket read_more" rel="nofollow" data-item="<?=$arItem['ID']?>" href="<?=$arItem['DETAIL_PAGE_URL']?>">22222<?=Loc::getMessage('CATALOG_READ_MORE')?></a>
											</div>
										</div>
									</div>
						...
						<div class="image_wrapper_block<?=($arParams['SHOW_PROPS'] == 'Y' && $arItem['DISPLAY_PROPERTIES'] && !$bBigBlock ? ' with-props' : '');?>">
							...
							<?if(!$bBigBlock):?>
								...
								<?if($arParams['SHOW_GALLERY'] == 'Y' && $arParams['SHOW_PROPS'] != 'Y'):?>
									...
									<?endif;?>
								<?else:?>
									<?\Helper\CHelperCommon::showImg($arParams, $arItem, false, true, '', 318, 238);?>
								<?endif;?>
							<?else:?>
								<?if($bFonImg):?>
									<div class="ce_cmp_visible">
