...
$APPLICATION->SetPageProperty("description", "Цена бетона с доставкой в #REGION_NAME_DECLINE_PP# за 1 м3. Актуальный прайс-лист #ZAVOD_NAME_RP# на #SELECT_2# год. Низкая стоимость куба бетона от производителя. Зафиксируем цену по договору и предоставим рассрочку. Скачать прайс завода «#SELECT_3#».");
$APPLICATION->SetPageProperty("title", "Бетон цена с доставкой в #REGION_NAME_DECLINE_PP# за 1 м3 – Стоимость бетона в #SELECT_2# году от #SELECT_6# руб за куб | «#SELECT_3#»");
$APPLICATION->SetPageProperty("viewed_show", "N");
$APPLICATION->SetTitle("Прайс-лист #ZAVOD_NAME_RP# на #SELECT_2# год");
?>
<div>
<?
