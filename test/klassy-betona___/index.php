...
$APPLICATION->SetPageProperty("tags", "Классы бетона, Производство, Прочность бетона");
$APPLICATION->SetPageProperty("description", "Узнайте, какие классы бетона существуют и как правильно выбрать подходящий для строительства. Все о стандартных классах прочности и свойствах бетона.");
//$APPLICATION->SetPageProperty("keywords", "классы бетона, прочность бетона, маркировка бетона, свойства бетона, выбор бетона, строительство, материалы для строительства");
$APPLICATION->SetPageProperty("title", "Классы бетона – как выбрать подходящий для строительства");
$APPLICATION->SetTitle("Классы бетона – как выбрать подходящий для строительства");
?><?$APPLICATION->IncludeComponent(
	"bitrix:news", 
	"partners", 
	array(
		"T_PREV_LINK" => "Список Классы бетона",
		"ADD_ELEMENT_CHAIN" => "Y",
		...
		"T_DOCS" => "",
		"T_PROJECTS" => "",
		"LINKED_PRODUCTS_PROPERTY" => "CLASSES",
		...
		"T_GOODS" => "Производство раствора класса #BRAND_NAME# на заводе «#SELECT_3#»",
		"T_GALLERY" => "Галерея",
		"SHOW_GALLERY" => "Y",
		...
		"BLOCK_PROJECTS_NAME" => "Раствор этого класса применялся в наших проектах",
		"BLOCK_BRANDS_NAME" => "Соответствующая классу марка бетона",
		"BLOCK_BLOG_NAME" => "Статьи",
		"BLOCK_LANDINGS_NAME" => "Коллекции",
		"IBLOCK_LINK_PARTNERS_ID" => "23",
		"BLOCK_PARTNERS_NAME" => "Клиенты",
		"GALLERY_TYPE" => "small",
		"STAFF_TYPE_DETAIL" => "list",
		"DETAIL_LINKED_GOODS_SLIDER" => "Y",
		"DETAIL_BLOCKS_ALL_ORDER" => "desc,tizers,goods,char,docs,vacancy,projects,brands,services,staff,gallery,partners,reviews,news,landings,goods_sections,goods_catalog,comments,blog,form_order",
