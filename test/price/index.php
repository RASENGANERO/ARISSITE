...
$APPLICATION->SetPageProperty("description", "Прайс бетонного завода «#SELECT_3#» с оптовыми ценами за м3 на строительные материалы в #REGION_NAME_DECLINE_PP#. Выгодные условия доставки для оптовых покупателей. Зафиксируем цену по договору и предоставим рассрочку. Скачать оптовый прайс на продукцию завода «#SELECT_3#».");
$APPLICATION->SetPageProperty("title", "Прайс-лист бетонного завода «#SELECT_3#» на #SELECT_2# год – Доступные цены на все виды строительных материалов");
$APPLICATION->SetPageProperty("viewed_show", "N");
$APPLICATION->SetTitle("Оптовый прайс-лист #ZAVOD_NAME_RP# на #SELECT_2# год");
?>
<div>
<?
...
?>
    ...
    <br>
<?
if($regionDescriptionBottom = show_region_descripotion(true)){
    echo $regionDescriptionBottom;
}else{?>
    <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
            "AREA_FILE_SHOW" => "sect",
