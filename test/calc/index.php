...
$APPLICATION->SetPageProperty("title", "Калькулятор расчёта цены бетона за 1 куб с доставкой в #REGION_NAME_DECLINE_PP# и Московской области");
//$APPLICATION->SetPageProperty("description", "✯ Рассчитать цену готовой бетонной смеси за 1 куб с доставкой по #REGION_NAME_DECLINE_TP# и Московской области с помощью онлайн калькулятора бетонного завода в #REGION_NAME_DECLINE_PP#. Калькулятор стоимости товарного бетона с доставкой с построением маршрута на карте от ближайшего бетонного завода.");
$APPLICATION->SetPageProperty("description", "Калькулятор стоимости бетона и сыпучих строительных смесей. Укажите: марку, класс, прочность, наполнитель, тип сертификации и необходимый объем - отобразится цена за куб бетона с доставкой в #REGION_NAME_DECLINE_PP#.");
$APPLICATION->SetTitle("Калькулятор цены бетона с доставкой 1 м3 с построением маршрута на карте #REGION_NAME_DECLINE_RP#");
?>            <?
            global $CANONICAL;
            $CANONICAL = "Y";
            global $fastOrder;
            ...
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "H1" => "Калькулятор стоимости бетона с доставкой",
                    "PATH_DESCRIPTION_AREA" => "include/mainpage/inc_files/fastorderCalcIndex.php"
                ),
                $component
            );
            ?>
