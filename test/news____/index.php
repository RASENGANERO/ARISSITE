...
$APPLICATION->SetPageProperty("tags", "Новости, Технологии, Строительство, Социальная работа");
$APPLICATION->SetPageProperty("description", "Новости монолитного строительства и производства готового бетона на бетонном заводе в #REGION_NAME_DECLINE_PP#. Тренды и достижения компании, социальные проекты, новинки и лучшие современные практики доставки и заливки бетонной смеси.");
//$APPLICATION->SetPageProperty("keywords", "Новости, бетон, производство, область, качество, технология, #REGION_NAME#");
$APPLICATION->SetPageProperty("title", "Новости производственной компании «Московский бетон» — производителя бетонных смесей в #REGION_NAME_DECLINE_PP#");
$APPLICATION->SetTitle("Новости бетонного производства и строительства в #REGION_NAME_DECLINE_PP#");
?>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_BLOCKS_ALL_ORDER" => "tizers,desc,gallery,docs,char,goods,services,blog,vacancy,news,form_order,projects,reviews,brands,landings,staff,comments,video,partners,sale",
